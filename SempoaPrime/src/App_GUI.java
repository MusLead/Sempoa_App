...
public class App_GUI implements java.awt.event.ActionListener, KeyListener {
    /**
    ...
    */
     ...
     */
    private static void defaultTemplate(){
        ...
        panel.add(ansField);
        ansField.addKeyListener(new App_GUI());
        
        optionButton = new JButton(optionsState);
        optionButton.setBounds(10, 50, 80, 25);
        optionButton.addActionListener(new App_GUI());
        panel.add(optionButton);

        startButton = new JButton("start");
        startButton.setBounds(100, 80, 80, 25);
        startButton.addActionListener(new App_GUI());
